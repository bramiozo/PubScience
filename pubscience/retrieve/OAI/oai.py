...
sources = {
    ...
    'TUE': {'link': f'https://pure.uvt.nl/ws/oai?metadataPrefix=oai_dc&verb=ListRecords&set=publications:year{YYYY}:withFiles', 
                ...
                'subject': 'subject',
                'type': 'type'},
    'UTwente':{'link': f'https://ris.utwente.nl/ws/oai?metadataPrefix=oai_dc&verb=ListRecords&set=publications:{YYYY}:withFiles',
               'pdf': 'identifier',
               'follow': 'direct',
               'lang': 'language',
               'date': 'date',
               'subject': 'subject',
               'type': 'type'}
    'RUG': {'link': f'https://pure.rug.nl/ws/oai?metadataPrefix=oai_dc&verb=ListRecords&set=publications:year{YYYY}:withFiles',
            'pdf': 'identifier',
            'follow': 'direct',
            'lang': 'language',
            'date': 'date', 
    ...
    'Leiden': {'link': f'https://scholarlypublications.universiteitleiden.nl/oai2?metadataPrefix=oai_dc&verb=ListRecords&set={SET}',
              'pdf': 'dc:identifier',
              'follow': 'retrieve',
              'language': 'dc:language',
              'type': 'dc:type',
