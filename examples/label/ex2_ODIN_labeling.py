...
import deduce
from pubscience.label import text as text_labeler
...
for kwargs in kwargs_list:
    print(f"Starting with {kwargs['model']}")
    OUTPUT_LOC = os.path.join(PARQUET_DIR, f"labeled_texts_{kwargs['model']}.jsonl")
    
    TextLabeler = text_labeler.extract(**kwargs)
